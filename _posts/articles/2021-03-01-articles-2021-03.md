...
> It’s nowhere near as mature or capable of commercial production management software, but it fits me.\
> I understand what it does and why, how it does it, the limitations it has and how to work around them.\
> When it becomes annoying enough, I might sit down and work out how to fix it, but I’ll do that when I’m in the right frame of mind.
...
## [Variable Environment in JavaScript](https://javascript.plainenglish.io/variable-environment-in-javascript-61630b5e76a9)

An Execution Context (EC) always contains three parts — a variable environment, the scope chain in the current context, and this keyword.

# 2021/03/31

## [Font size is useless; let’s fix it](https://tonsky.me/blog/font-size/)

## 🌟 [A Guide to Jotai: the Minimalist React State Management Library](https://dmitripavlutin.com/react-jotai-state-management/)
